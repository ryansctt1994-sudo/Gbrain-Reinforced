...
[![Benchmarks](https://img.shields.io/badge/P%405-49.1%25_R%405-97.9%25-orange)]()
[![Structure](https://img.shields.io/badge/Structure-Reviewed_by_%40LabyrinthCoder-teal)]()

**Start here depending on who you are:**

| If you are... | Read this first |
|---------------|----------------|
| An AI agent | [`AGENTS.md`](AGENTS.md) — install + operating protocol |
| Claude | [`CLAUDE.md`](CLAUDE.md) — architecture, trust boundary, privacy rules |
| A new developer | [`CONTRIBUTING.md`](CONTRIBUTING.md) — dev setup and project structure |
| New to the repo | [`WHAT_THIS_IS.md`](WHAT_THIS_IS.md) — one-page orientation |
| Mapping the codebase | [`STRUCTURE.md`](STRUCTURE.md) — complete folder map with file counts |
| Reviewing open items | [`KNOWN_GAPS.md`](KNOWN_GAPS.md) — current gaps, security items, optional additions |
| Reviewing this PR | [`REVIEW_NOTES.md`](REVIEW_NOTES.md) — what changed, what didn't, and why |

**Optional reflective notes** from the structural review are in [`bonus/labyrinth-reflections/`](bonus/labyrinth-reflections/) — not required for runtime.
